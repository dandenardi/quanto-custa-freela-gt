    ...
    <div className="App">
      <header className="App-header">
        ...
        <form className="form" onSubmit={handleForm}>
          ...
          <input type="number" value = {earnPerMonth} onChange = {(e) =>  setEarnPerMonth(e.target.value)}></input>
          <label>Quantas horas trabalharei por mês:</label>
          <input type="number" value = {hourWorked} onChange = {(e) => setHourWorked(e.target.value)}></input>
          <label>Quantidade de horas para este projeto:</label>
          <input type="number" value = {hoursPerProject} onChange = {(e) => setHoursPerProject(e.target.value)}></input>
